...
func (paseto *PasetoMaker) CreateToken(username string, securityKey string, duration time.Duration) (string, *Payload, error) {
	payload, err := NewPayload(username, securityKey, duration)
